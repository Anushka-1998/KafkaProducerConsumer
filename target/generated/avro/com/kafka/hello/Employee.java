...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1842391534762799583L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"com.kafka.hello\",\"doc\":\"Represents an Employee at a company\",\"fields\":[{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public Employee(java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
   ...
   */
  public static com.kafka.hello.Employee.Builder newBuilder() {
    return new com.kafka.hello.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.kafka.hello.Employee.Builder newBuilder(com.kafka.hello.Employee.Builder other) {
    return new com.kafka.hello.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.kafka.hello.Employee.Builder newBuilder(com.kafka.hello.Employee other) {
    return new com.kafka.hello.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.hello.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.hello.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.hello.Employee.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.hello.Employee.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.hello.Employee.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.hello.Employee.Builder clearLastName() {
      lastName = null;
